...
const aes_server_key = "efsdsbafa6xFe8lcg==";
const aes_server_iv = "o2muxyVs5cwedbQ==";
const aes_client_key = "weJGsdsdf6FxF9==";
const aes_client_iv = "sewg29nsl=";
const des_key = "sgfsfKsg8723jF==";
const des_iv = "yfw3wexsd=";
...
// method是请求的数据'GETMONTHDATA'qi,大写; param 是字典, {'city': city, 'month': '2013-12', ...}
